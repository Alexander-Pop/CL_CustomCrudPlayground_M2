...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData() {
        ...
        if (empty($this->loadedData)) {
            ...
            if ($block->getData('codelegacy_contactsimage') != null) {
                $t2[$block->getId()] = $temp;
                return $t2;
            } else {
                // unserialize the multi selected data.
                // $this->loadedData[$block->getData('codelegacy_contacts_id')]['parent_category'] = unserialize($this->loadedData[$block->getData('codelegacy_contacts_id')]['parent_category']);
                return $this->loadedData;
            }
