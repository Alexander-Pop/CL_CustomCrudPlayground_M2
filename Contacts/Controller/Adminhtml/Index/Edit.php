...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Codelegacy_Contacts::codelegacy_contacts')
            ...
            ->addBreadcrumb(__('Contacts Manager'), __('Contacts Manager'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('codelegacy_contacts', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? __('Reply to "%1"', $model->getFName() . " " .$model->getLName()) : __('Add New'));
