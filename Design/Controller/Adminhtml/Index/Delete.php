    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                $model = $this->_objectManager->create('Codelegacy\Design\Model\Design');
                $model->load($id);
                ...
                // go to grid
                /*$this->_edesignManager->dispatch(
                    'adminhtml_codelegacy_design_on_delete',
                ...
                return $resultRedirect->setPath('*/*/edit', ['codelegacy_design_id' => $id]);
            }
        }
        // display error message
        $this->messageManager->addError(__('We can\'t find a codelegacy design to delete.'));
        // go to grid
        return $resultRedirect->setPath('*/*/');
    }
}
