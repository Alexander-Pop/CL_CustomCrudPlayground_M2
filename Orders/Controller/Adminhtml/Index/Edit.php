...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Codelegacy_Orders::codelegacy_orders')
            ...
            ->addBreadcrumb(__('Orders Manager'), __('Orders Manager'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('codelegacy_orders', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(
            $id ? __('Reply Codelegacy') : __('Add New'),
            $id ? __('Reply Codelegacy') : __('Add New')
        );
        $resultPage->getConfig()->getTitle()->prepend(__("Order of : ".$model->getCustomerName()));
        // $resultPage->getConfig()->getTitle()
        //     ->prepend($model->getId() ? __('Order of "%1"', $model->getCustomerName() . " " .$model->getCustomerName()) : __('Add New'));
