    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                // go to grid
                /*$this->_efontManager->dispatch(
                    'adminhtml_codelegacy_font_on_delete',
                ...
                return $resultRedirect->setPath('*/*/edit', ['codelegacy_font_id' => $id]);
            }
        }
        // display error message
        $this->messageManager->addError(__('We can\'t find a codelegacy font to delete.'));
        // go to grid
        return $resultRedirect->setPath('*/*/');
    }
}
